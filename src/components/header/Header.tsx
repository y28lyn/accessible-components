export const Header = () => {
  return (
    <div className="relative flex flex-col-reverse py-28 lg:pt-0 lg:flex-col lg:pb-0 overflow-hidden h-screen">
      ...
      <div className="md:my-auto relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
